...
\autoref{img:variational-commits} please find a picture of the commit history I made during
...
adjustment again $\ldots$' (see \autoref{img:interactive-picture-software-dev}).
...
\autoref{img:interactive-picture-software-dev}.
