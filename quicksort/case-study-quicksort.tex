...
As mentioned above, asymmetric traversal in quicksort partition is the root cause of Lomuto's
performance degradation.
To overcome the drawback, we need symmetric traversal with two pointers meeting each other.
...
However one should never underestimate the added complexity due to the minor change.
