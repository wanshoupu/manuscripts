...
The iterative way uses double stacks.
...
The algorithm implemented here can be viewed as a generalized `shunting-yard' algorithm that works
for assembling arrays and objects which may be viewed as variable-length n-nary operators.
% TODO graphics for the algorithm and the multi-recursion to be added
...
This is because the regular \code{dict} in \python doesn't preserve the original order of entries
in the object value of JSON\@.

Refactored JsonAssembler, a multi-recursive version.
The refactored version are explained below.

\begin{table}[H]
\lstinputlisting{case-study/my-json/NewJsonAssembler.py}
\end{table}

\begin{table}[H]
\lstinputlisting{case-study/my-json/NewJsonAssembler_dispatcher.py}
\end{table}

\begin{table}[H]
\lstinputlisting{case-study/my-json/NewJsonAssembler_array.py}
\end{table}

\begin{table}[H]
\lstinputlisting{case-study/my-json/NewJsonAssembler_struct.py}
\end{table}
