...
My advice is `Beat all the odds to keep it no more than 2'.
...
\begin{itemize}
    \item Lengthy logic to obtain certain an intermediate value or object
    \item A code snippet whose runtime complexity may be drastically different from the main
    \item A portion of the code need concurrent control such as entering a critical section
    \item Certain portion but not all of the code need error handling as a \code{try .. catch}
    \item Occurrences of a squad of statements at multiple places
