...
Namely, relocate the \emph{pre-inner-loop} statements (~\autoref{lst:relocate-pre-inner-loop}),
...
\begin{minipage}[t]{.4\textwidth}
    \lstinputlisting[label={lst:relocate-pre-inner-loop},language=C,caption={Code after moving away
    \emph{pre-innner-loop} statements.}]
