...
made in regard of ``how, when, where, and what''.
As such, myriad traps lay in wait throughout the implementation process.
We will leave the discussions of frequently-made bugs encountered during this implementation in
~\autoref{sec:impl-varieties}.


To the author, the utmost thing is to get rid of the nested loops.
