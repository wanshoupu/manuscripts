...
\lstinputlisting{if-else/tight_staircase_conditional.java}
...
\begin{clisting}
    \begin{minipage}[t]{.45\textwidth}
        \lstinputlisting[caption={Refactor SC to another function},
        label={lst:refactor_staircase_conditional},
        firstline=1,lastline=4]
        {if-else/refactor_staircase_conditional.java}
    \end{minipage}
    \hspace{1mm}
    \begin{minipage}[t]{.45\textwidth}
        \lstinputlisting[caption={Use a helper function in SC},
        label={lst:modified_tight_staircase_conditional},
        firstline=6,lastline=6]
