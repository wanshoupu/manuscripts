...
\begin{clisting}
    ...
    caption={Linked list real code.}]{LinkedListAlgorithms.java}
\end{clisting}


\begin{figure}
    \includegraphics[width=\textwidth]{anchored-doubly-linked-list.jpg}
...
\begin{table}[b]
    \begin{center}
        ...
        \begin{tabular}{p{7cm}|p{7cm}}
            Option 1 & Option 2  \\
            \lstinputlisting{linked_list_operation1.java}
            &
            \lstinputlisting{linked_list_operation2.java} \\
        \end{tabular}
    \end{center}
\end{table}
...
\begin{table}[b]
    \begin{center}
        ...
        \begin{tabular}{p{7cm}|p{7cm}}
            Option 1 & Option 2  \\
            \lstinputlisting{linked_list_operation3.java}
            &
            \lstinputlisting{linked_list_operation4.java} \\
        \end{tabular}
    \end{center}
\end{table}
