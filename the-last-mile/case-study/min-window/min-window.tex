...
As we have discussed in this chapter is a typical problem that has both an simple problem
statement and an intuitive algorithm.
However coding up a solution for it is by no means simple or straightforward.
For an inexperienced beginner, the implementation can easily blow up as a bloated, buggy chunk of
obscure program.
When I first encountered this problem, I stumbled badly after a few failed attempts to
implement a clean and readable solution using languages like \java and \python.
