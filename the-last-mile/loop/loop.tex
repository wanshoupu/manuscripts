...
consider deduplicate the post-loop code using a technique to be explained below.
...
\lstinputlisting[label={lst:histogram-oneMoreCycle},caption={Dedupe post-processing code with
`one-more-cycle' technique}]
