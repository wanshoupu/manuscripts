...
\lstinputlisting[]{loop/the-last-mile/loop/word_breaker_other_imp.py}

In light of the `loop rotation' technique, let us now focus on how to optimize
loop initialization.
One can think of initialization as a preclude, a bridge to the loop body.
It is a `primer coating' that makes a substrate for the loop to work on.

The requirement for loop initialization is `small'.
Let initialization be light-weight, do the minimal preparatory work and let the loop body do the
weight-lifting.
