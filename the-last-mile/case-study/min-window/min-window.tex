...
Also, because of this repeated check, the \code{for}-loop was made fragmented and quite lengthy.
...
An instance-based solution that reduce the number of parameters of several functions.
