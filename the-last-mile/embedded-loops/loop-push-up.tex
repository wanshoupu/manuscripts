...
Unlike the arduous implementation and debugging process of Hoarse's,
...
In comparison, the Hoarse partitioning scheme is stable and
...
\emph{and} the performance of Hoarse's?''
...
\lstinputlisting[label={lst:nestedLoopHoarePartSingleLoop},language=C,escapechar=$,
...
Lomuto's and the robust performance of Hoarse's.
...
~\autoref{lst:nestedLoopHoarePartSingleLoop}) would not be necessary.
