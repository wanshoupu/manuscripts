...
But only recently
it came to my realization that high-end software developers have remained rare commodities all
along.
...
bit of scientifc research background.
You guessed right, I didn't achieve much in research, either.
So that background doesn't lend me much credentials here, either.

But I want to assure you that I still get something that you will find amusing to read on.
I struggled for 10 years to get to the bottom of everything I wanted to while in practice.
My deep immersion in this field was materialized in thousands of pages of notes and dairies, 30k
lines of coding practices, and 100k+ lines of deployed production code at top-tier tech firms.
