...
\lstinputlisting{pre_test_loop.java}
...
\lstinputlisting{post_test_loop.java}
...
\lstinputlisting{mid_test_loop.java}
...
\lstinputlisting[language=Python]{use_of_continue.py}
It is marvelous!
...
%        {conditional_in_loop_no_continue.java}
%    \end{minipage}\hfill
%    \begin{minipage}[t]{.45\textwidth}
%        \lstinputlisting[caption={Using \code{if..continue}.}]
%        {conditional_in_loop_continue.java}
%    \end{minipage}
%\end{clisting}
...
%        {loop_cond_redundant_testing.java}
%    \end{minipage}\hfill
%    \begin{minipage}[t]{.45\textwidth}
%        \lstinputlisting[caption={Simplified code}]
%        {loop_cond_repeated_block.java}
%    \end{minipage}
%\end{clisting}
...
%    \lstinputlisting{loop_cond_no_redundancy.java}
%\end{minipage}
...
\lstinputlisting[lastline=12]{refactor_conditional_in_loop.java}
...
\lstinputlisting[firstline=14]{refactor_conditional_in_loop.java}
...
\begin{clisting}[H]
    \lstinputlisting[]{board_game_dupcode.py}
\end{clisting}
...
\begin{clisting}[H]
    \lstinputlisting[]{board_game_dupcode-0.py}
\end{clisting}
Now watch closely---let us roll up one line:
\begin{clisting}[H]
    \lstinputlisting[]{board_game_dupcode-1.py}
\end{clisting}
...
\begin{clisting}[H]
    \lstinputlisting[]{board_game_rotated.py}
\end{clisting}
...
looks like
\lstinputlisting[]{spiral_termination_todo.py}
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=.4\textwidth]{spiral-term.jpg}
...
\lstinputlisting[]{spiral_termination_final.py}
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=.4\textwidth]{spiral-term-init.png}
...
\lstinputlisting[]{spiral_termination_virtual_init.py}
...
\lstinputlisting[]{spiral_termination_two_liner.py}
...
\lstinputlisting[]{histogram_verbose.java}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.7\textwidth]{happy_number.png}
...
caption={Dynamic stepping in a loop}]{nonlinear_stepping_example.py}
...
%\lstinputlisting[]{NumberOfPath.java}
%\lstinputlisting[]{WildcardStringMatching.java}
