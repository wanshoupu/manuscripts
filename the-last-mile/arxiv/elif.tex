...
\lstinputlisting[firstline=2,lastline=11]{test1_test2_append.py}
to a one-liner.
\lstinputlisting[firstline=14]{test1_test2_append.py}
...
do you care?
\lstinputlisting{switching-smell-code-snippet.py}
...
\begin{clisting}
    ...
    {equivalent_statements_if_return_real_world.java}
\end{clisting}
...
\begin{clisting}
    \begin{minipage}[t]{.45\textwidth}
        ...
        {equivalent_statements_if_return.java}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.45\textwidth}
...
%        {equivalent_statements_ternary_expr.java}
%    \end{subfigure}\hfill
%    \begin{minipage}[t]{.45\textwidth}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=.7\textwidth]{nested-conditionals.jpg}
...
\begin{clisting}
    \begin{minipage}[t]{.3\textwidth}
        ...
        caption={v1}]
        {composite_condition_tobe_simplified.java}
    \end{minipage}\hfill
    \begin{minipage}[t]{.3\textwidth}
        \lstinputlisting[label={lst:simpleBranching},
        caption={v2}]
        {composite_condition_simplified1.java}
    \end{minipage}\hfill
    \begin{minipage}[t]{.3\textwidth}
        \lstinputlisting[label={lst:final-simplified-conditional-statement},
        caption={v3}]
        {composite_condition_simplified2.java}
    \end{minipage}
\end{clisting}
...
\begin{clisting}
    \begin{minipage}[t]{.4\textwidth}
        ...
        {binary_search_direction_nested.py}
    \end{minipage}\hfill
    \begin{minipage}[t]{.4\textwidth}
        \lstinputlisting[label={lst:binary-search-direction-nested},
        caption={Simplified implementation of binary searching direction logic}]
        {binary_search_direction_simplified.py}
    \end{minipage}
\end{clisting}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=.7\textwidth]{short-circuit.jpg}
...
\begin{quote}
    ...
    \lstinputlisting{getNext_procure.java}
\end{quote}
...
\lstinputlisting{getNext_shortCircuit.java}
...
\lstinputlisting{zoo_animal_health_exam_dup_code.py}
...
\lstinputlisting{zoo_animal_health_exam_nested_cond.py}
...
{zoo_animal_health_exam_continue.py}
...
\begin{clisting}[ht]
    ...
    {zoo_animal_health_exam_refactored.py}
\end{clisting}
