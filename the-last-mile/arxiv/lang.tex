...
\lstinputlisting{reshape_comprehension.py}
\lstinputlisting{reshape_double_comprehension.py}
\lstinputlisting{reshape_iter.py}
...
In comparison, \java
%TODO
\lstinputlisting[caption={Equivalent code snippets}]{equivalent_statements.java}
