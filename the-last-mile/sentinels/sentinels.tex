...
\begin{quote}
    Given a sorted integer array where the range of elements are \code{[0, 99]} inclusive,
    return its missing ranges.
    For example, given \code{[0, 1, 3, 50, 75]},
    return \code{["2", "4->49", "51->74", "76->99"]}
\end{quote}
...
Note the addition of sentinel 'upper+1' cuts off the cluttered post-loop processing logic
completely without any side effect.
This is a neat application of sentinel I have ever seen.

\section{Conclusion}

Above we presented the power of sentinels and gave a few examples to illustrate the uses of
them.
