...
While they may solve our problem, nested loops inflict a program with
unnecessary complexity, obstruct code readability, bring in `soft duplication'.
...
To that end, use `loop rotation' technique (see ~\autoref{sec:loop-rotation}) backward
