...
page.
\clearpage
If you come up with the following solution, you scored $100\%$.
\lstinputlisting[firstline=2,lastline=11]{if-else/test1_test2_append.py}
If you can turn this blob into a one-liner, you have my congratulations!
\lstinputlisting[firstline=14]{if-else/test1_test2_append.py}
But if you haven't made it your habit to strive for this level of succinctness in coding,
then the rest of this chapter is just for you.
...
\subsection{How to refactor nested conditionals to cascading conditionals}

\code{lookup} is a dictionary (or a \code{HashMap}) with integer key and \code{Array} value.
\lstinputlisting[lastline=12]{if-else/nested_conditional_2_cascading_conditional.py}
\clearpage
