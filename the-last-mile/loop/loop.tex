...
\section{Minimal Post-loop Processing}\label{sec:one-more-loop}
...
on LeetCode, implementations more or less like the following are common:
...
Of course, the code, as is now, does not work.
Why?
