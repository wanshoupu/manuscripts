...
The entropy of a thermodynamic system is logarithmically proportional to the
number of `accessible microstates'.
Now if we take the $N$-particle system as the $N$-entities array and the `accessible microstates'
as all the permutations, then the formula suddenly makes sense
(Refer to ~\fullref{ch:timeComplexityOfSorting} for a more detailed explanation on this).
