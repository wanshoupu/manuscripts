...
Finally, when one runs out of wit in the thought process, one needs a way to `jump out of the
box' by adding extra dimensions.
For example, turning the solution into a composite construct, such as an array, a set or a map.
