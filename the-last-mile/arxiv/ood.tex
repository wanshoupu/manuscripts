...
label={lst:longestDistinctCharSubstring}, language=Python]{longest_k_uniq_char_substring.py}
...
label={lst:longestDistinctCharSubstring}, language=Python]{flatten_2d_array.py}
\label{Evernote:Flatten 2D Vector}

\lstinputlisting[caption={Example showing usage of object-oriented-design in functional coding},
label={lst:longestDistinctCharSubstring}, language=Python]{flatten_3d_array.py}
...
{closest_binary_tree_II_2018.py}
...
\begin{clisting}
    ...
    caption={First implementation.}]{bound_heap.py}
\end{clisting}
...
{MatrixIteratorHasNextIdempotent.java}
...
{kafka_client_producer_consumer.java}
