...
SRP-compliant functions, we may subject them to extensive unit tests.
My own test result reveals that it can successfully process JSON text of size 189MB,
it can process JSON text with
recursion depth of some limitation.
Regardless, tests strengthen our confidence in its correctness.
%TODO
