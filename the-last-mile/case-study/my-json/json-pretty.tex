...
attacked.
First of all, let us see if we simplify the twisted logic for ``all-but-last'' field separator
for array and object entries.
...
indenting a line also need to be redefined to ``insert certain number of
