...
Also form a good judgement on when to perform a refactor.
As to the threshold beyond which one would be compelled to perform a refactor, this is a sense of
personal judgement.
One the one hand, one should not perform senseless refactor ``as soon as you spot a shadow.''
On the other, one does not want to be lazy as creating lousy code and pushing off paying large
technical debts.
Usually when I spot `duplicate code smell' \emph{accompanied} by nested conditionals, I would
