...
~\autoref{lst:JsonPrettifier.py}, ~\autoref{lst:JsonFormatter.py},
and ~\autoref{lst:JsonParser.py}.

\lstinputlisting[label={lst:JsonPrettifier.py},
...
Now let us revisit the json formatter code since I believe there are still something we can learn
from.
