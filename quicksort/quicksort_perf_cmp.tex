The above implementation for quicksort is only a simplification.
Our implementation have the same runtime complexity as the traditional ones.
As such, we have designed experiments to test this hypothesis.
Implicitly, we use the ``median-of-three'' pivot selection technique to prevent pivot skewness
in all the quicksort implementations in this article\cite{sedgewick1977,sedgewick:1978}.
