...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=.7\textwidth]{spiral-matrix.jpg}
...
\begin{clisting}
    ...
    {pseudo_spiral_order_recursive.py}
\end{clisting}
\newpage
...
\begin{figure}[t]
    ...
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{cycle-asymmetric.jpg}
        \caption{Asymmetric cycle division.}
        \label{fig:cycle.division.asymmetric}
    \end{subfigure}
    \vspace{2mm}
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{cycle-corner-special.jpg}
        \caption{Division singling out corner cells.}
        \label{fig:cycle.division.corner.special}
    \end{subfigure}
    \vspace{2mm}
    \begin{subfigure}{.3\textwidth}
        \includegraphics[width=\textwidth]{cycle-symmetric.jpg}
...
{spiral_matrix_iterator_interface.py}
