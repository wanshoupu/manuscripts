...
The prevalence of hierarchical structures in software systems is caused by SRP and
divide-and-conquer.
According to SRP, each module should have one and only one purpose.
As to a specific function, it should do one and only one thing.
Why not two or more?
