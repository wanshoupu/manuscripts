...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[height=6cm]{hierarchy-of-capsule.jpg}
...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[height=8cm]{functree.jpg}
        \caption{
...
\begin{clisting}
    ...
    caption={Jump Game II: an implementation with nested loops.}]{ValidNumber.java}
\end{clisting}
...
\begin{clisting}
    ...
    {humongous_buggy_find_shapes.py}
    \lstinputlisting[label={lst:conneted_shapes},
