...
It came to my attention that high-end software developers are rare commodities these days.
To convince yourself, take a peek at repositories at \url{github.com}, search famous Apache projects
such as Hadoop, Spark, Apache Common Libraries, \textit{etc.}.
It should not take long to identify the `smells' as listed in Martin Fowler's ``Refactoring'' book.
These simply signals the lack of craftsmanship in the community.
There are beliefs flowing around that put a lot of emphasis on architecture design, and even
interface designs.
But less attention is being given to quality implementations.
Putting this in light of the shortage of software engineering talent, this is rather a make-shift
than conscious choice.
This was made obvious that many famous projects came with a great design but implemented with
mediocrity.
It is because there are just not enough top-tier engineers working the projects.
There are simply too much tasks to perform.
The few top-notch gurus focused their energy on something else.
...
2018 \footnote{\url{https://www.lingolive.com/2018s-software-engineering-talent-shore
...
I've worked with all top-tier school graduates and post-graduates.
They may come with latest theories in computer sciences.
Their resumes may be full of buzz words skills such as artificial intelligence.
But at end of the day, when it comes to coding, the incompetence manifests itself.
...
mentorship.
It takes years of real-world combat attending to sharpen the skills.
This book would not and is never my pursuance to help you cut short the path to achieve this level
of proficiency.

What I want to achieve through this book is that one may be inspired to immerse
