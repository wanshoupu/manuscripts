...
Often, one can get clues by trying one of several ways. One way is to seek restricted subproblems.
These subproblems would otherwise be just the original one. But they are bounded by a single
restriction.
