...
We dedicate ~\fulref{ch:embedded-loops} solely to this topic and presents techniques to help
...
As another helpful analogy, loops to a program are like spools to yarn.
Spools are used to organize yarns whereas loops are used as a program construct.
%TODO
...
Then one can start `rotating the loop'---rotating the statements in the loop body, align and
