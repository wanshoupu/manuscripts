...
{JsonTokenizer_with_no_lah_problem.py}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{generalized-shunting-yard-algo.jpg}
...
{NewJsonAssembler_dispatcher.py}
\end{table}
...
{JsonFormatter_comprehension.py}
...
{JsonFormatter_array_formatting_separate_element.py}
...
\includegraphics[width=\textwidth]{line-view-a.jpg}
\caption{Line view a.\label{fig:line-view-a}}
\end{subfigure}
\\
\vspace{1mm}
\begin{subfigure}{.8\textwidth}
\includegraphics[width=\textwidth]{line-view-b.jpg}
...
{JsonFormatter_array_element_shifted_view.py}
...
caption={Array formatting function with element formatting string shifted to one side.}]
{JsonFormatter_array_element_true_str_join.py}
...
{JsonFormatter_indent_function.py}
...
{JsonFormatter_array_element_separate_indent.py}
