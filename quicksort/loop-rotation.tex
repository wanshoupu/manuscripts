\begin{figure}[htb]
    ...
    the loop.}
\end{figure}
Observing two of the characteristics of loop is the key of loop programming.
First, there are many moving parts in a loop construct and they are tightly
coupled---changes in one necessitate changes in several others.
Secondly, a loop is usually not alone---it does not live in vacuum
but interacts with other part of a program.
So it must get along with other code in its vicinity.
As a result, a large part of the programming task is to fit loop in the program.
