...
It is not exaggerating to say that ``The majority of work of programming a loop is outside of the
loop.''
...
Initialization is the gluing interface between code before the loop and the loop itself.
Initialization is like a layer of primer coating---it prepares the substrate on which the loop
carries on its further treatment.
