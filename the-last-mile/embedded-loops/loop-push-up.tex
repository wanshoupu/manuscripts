...
\begin{minipage}{\linewidth}
    ...
    caption={Jump Game II: an implementation with nested loops.}]{embedded-loops/jump_game_ii.java}
\end{minipage}

\begin{minipage}{\linewidth}
    \lstinputlisting[label={lst:jump_game_ii},firstline=10,lastline=31,
    caption={Jump Game II: an example of nested loop pushing up.}]{embedded-loops/jump_game_ii.py}
\end{minipage}
