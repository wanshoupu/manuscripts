...
On the opposite, if a function performs significant calculation and at the same time it fetches
internet resources, that is a clear violation of SRP and should be refactored.


When a complicated function is to be refactored, semantic analysis may shed light on how to start.
First the analysis may reveal the subtasks it performs.
Each of these subtasks may be a good candidate for new functions.
it up into groups with more cohesive code.
